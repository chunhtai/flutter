# Material Widgets for VPAT Assessment

This is a comprehensive list of Material widgets that are commonly used by Flutter developers and are good candidates for a VPAT (Voluntary Product Accessibility Template) assessment.

Widgets that are already covered in `dev/a11y_assessments` are marked.
