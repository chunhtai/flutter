...
class NavigatorState extends State<Navigator> with TickerProviderStateMixin {
  ...
  Future<T> push<T extends Object>(Route<T> route) {
    ...
    final Route<dynamic> oldRoute = _history.isNotEmpty ?
      _history.lastWhere(_RouteEntry.isPresentPredicate).route : null;
    ...
    if (!kReleaseMode) {
      ...
      if (route != null) {
        ...
        final Map<String, dynamic> settingsJsonable = <String, dynamic> {
          'name': settings.name,
          'isInitialRoute': settings.name == widget.initialRoute,
        };
  ...
  Future<T> pushReplacement<T extends Object, TO extends Object>(Route<T> newRoute, { TO result }) {
    ...
    final Route<dynamic> oldRoute = _history.last.route;
